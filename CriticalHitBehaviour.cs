...
public class CriticalHitBehaviour : StateMachineBehaviour
{
    private ShadowTrail shadowTrail;
    private Color originalColor;
    [SerializeField] public Color nuevoColor;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        shadowTrail = animator.gameObject.GetComponent<ShadowTrail>();
        originalColor = shadowTrail._Color;
        shadowTrail._Color = nuevoColor;
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.gameObject.GetComponent<ShadowTrail>()._Color = originalColor;
    }
